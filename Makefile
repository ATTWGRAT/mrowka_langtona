...
test: build
	...
	bin/mrowka.exe -m 17 -n 22 -k 'd' -o testout/test2/t2 -i 112 -f pliki_testowe/test2
	bin/mrowka.exe -m 20 -n 39 -k 'l' -o testout/test3/t3 -i 300 -f pliki_testowe/test3
